...
2. Search for the course you would like to obtain a gradebook for and go to its homepage. ![step2](https://github.com/byuitechops/d2l-gradebook-csv-to-canvas-gradebook-csv/blob/development/walkthrough/Slide2.PNG)
3. Press the **'My Grades'** Tab and press **'Grades'**. ![step3](https://github.com/byuitechops/d2l-gradebook-csv-to-canvas-gradebook-csv/blob/development/walkthrough/Slide3.PNG)
4. Press **'Export'**. ![step4](https://github.com/byuitechops/d2l-gradebook-csv-to-canvas-gradebook-csv/blob/development/walkthrough/Slide4.PNG)
...
6. Press **'Export to CSV'**. ![step5-6](https://github.com/byuitechops/d2l-gradebook-csv-to-canvas-gradebook-csv/blob/development/walkthrough/Slide5.PNG)
...
1. Ensure you have teacher-level access to the course. You can be added as a teacher for a course by doing the following:
  ...
  ![step7](https://github.com/byuitechops/d2l-gradebook-csv-to-canvas-gradebook-csv/blob/development/walkthrough/Slide6.PNG)
...
3. Under the **Actions** tab, select **Import**, press **Choose File**, then **Upload Data**.
  ...
  ![step8-9](https://github.com/byuitechops/d2l-gradebook-csv-to-canvas-gradebook-csv/blob/development/walkthrough/Slide7.PNG)
...
5. Match each Canvas **Assignment in question** name to your CSV's column names. Do not fill in the **Points Possible** input; the CSV contains percentages and Canvas will calculate the grades.
  ...
  ![step10-11](https://github.com/byuitechops/d2l-gradebook-csv-to-canvas-gradebook-csv/blob/development/walkthrough/Slide8.PNG)
6. Once step 5 is done successfully you will be directed to a new page with the new grades. Press **Save Changes**. You will be redirected back to the **Grades** tab, if you reload this page you should see the calculated grades for each imported grade.
  ...
  ![step12](https://github.com/byuitechops/d2l-gradebook-csv-to-canvas-gradebook-csv/blob/development/walkthrough/Slide5.PNG)